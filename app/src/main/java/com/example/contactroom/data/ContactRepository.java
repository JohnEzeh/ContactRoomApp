...
public class ContactRepository {
    ...
    public void update(Contact contact){
        ContactRoomDatabase.databaseWriterExecutor.execute(() -> contactDao.update(contact));
    }

    public void delete(Contact contact){
        ContactRoomDatabase.databaseWriterExecutor.execute(()-> contactDao.delete(contact));
    }
}
